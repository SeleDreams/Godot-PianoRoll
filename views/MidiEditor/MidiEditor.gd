...
func update_draw_area():
	update_zoom()
	midi_editor_view.midi_clip = midi_clip
...
func update_offsets(value):
	midi_editor_view.horizontal_offset = h_scrollbar.value
	midi_editor_view.vertical_offset = v_scrollbar.value
	update_draw_area()
...
func update_zoom():
	...
	midi_editor_view.vertical_scale = vertical_scale * vzoom
	midi_editor_view.horizontal_scale = horizontal_scale * hzoom
	midi_editor_view.total_horizontal_size =  (horizontal_scale * hzoom * max_bar_count / midi_clip.timesig_denominator * bpm_factor) + 20
	midi_editor_view.total_vertical_size = vertical_scale * vzoom * number_octaves * 12 
